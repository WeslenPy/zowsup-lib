...
class YowBot: 
    ...
    def runAsThread(self):
        ...
        self.thread = threading.Thread(name=f"runner_{self.botId}", target=_runner)
    ...
    def getSentMessagesCount(self, params, options):
        ...
        """
        from zowsuplib.app.db import get_sent_messages_count
    ...
    @BotCmd("group.setsubject","set group subject/name")
