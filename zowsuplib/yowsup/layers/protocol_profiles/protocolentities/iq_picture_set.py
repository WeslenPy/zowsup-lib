...
'''
    def __init__(self, jid, previewData, pictureData, pictureId = None, _id = None,target=None):
        super(SetPictureIqProtocolEntity, self).__init__(to = jid,_id= _id, type ="set",target=target)
