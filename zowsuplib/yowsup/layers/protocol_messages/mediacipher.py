from zowsuplib.axolotl.kdf.hkdfv3 import HKDFv3
from zowsuplib.axolotl.util.byteutil import ByteUtil
...
class MediaCipher(object):
    ...
    def encrypt_history_sync(self,ciphertext,ref_key):
        return self.encrypt(ciphertext, ref_key, self.INFO_HISTORY_SYNC)
    
    def encrypt_app_state(self,ciphertext,ref_key):
    ...
    def decrypt_history_sync(self,ciphertext,ref_key):
